...
{ 
     echo "<h2> Ваше сообщение успешно отправлено.<br> С вами свяжутся через некоторое время. </h2>"; 
} 
	else
{ 
     echo "<h2> При отправке сообщения возникли ошибки. Проверьте правильность написания email <br><br><br><br><br><br><br><br></h2>";
